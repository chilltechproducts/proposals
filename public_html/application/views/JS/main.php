...
function last_proposal(){
    $.ajax({
        url: '/proposals/last_proposal',
        type: 'post',
        dataType: 'html',
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            $.each(response.data, function(i, item){
                ...
                html = '<li class="row ' + idd_even + '"><span class="name inline">' + item.first_name + ' ' + item.last_name + '</span><span class="name email">' + item.email + '<br /> ' + item.street_address + ' ' + item.city + ', ' + item.state + ' ' + item.postal_code + '<br /> ' + item.business_phone + '</span><span class="inline status">' + item.status + '</span><span class="inline buttons"><i class="fa fa-close"></i><i class="fa fa-pencil" onclick="load_profile(' + item.user_id + ')"></i><i class="fa fa-eye"></i></span></li>';
